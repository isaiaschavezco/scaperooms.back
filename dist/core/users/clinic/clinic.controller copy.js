...
let ClinicController = class ClinicController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.clinicService.findAll();
        });
    }
    create(createDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.clinicService.create(createDTO);
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.clinicService.delete(id);
        });
    }
};
__decorate([
