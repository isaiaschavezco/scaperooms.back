...
let PositionController = class PositionController {
    ...
    findAllNaosPositions() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.positionService.findAllNaosPositions();
        });
    }
    findNaosPositionById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.positionService.findNaosPositionById(id);
        });
    }
};
__decorate([
...
], PositionController.prototype, "findAllNaosPositions", null);
__decorate([
    common_1.Get(':id'),
    ...
    __metadata("design:returntype", Promise)
], PositionController.prototype, "findNaosPositionById", null);
