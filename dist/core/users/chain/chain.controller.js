...
const chain_dto_1 = require("./chain.dto");
let ChainController = class ChainController {
    ...
    findAll() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.chainService.findAll();
        });
    }
    create(createDTO) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.chainService.create(createDTO);
        });
    }
    delete(id) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.chainService.delete(id);
        });
    }
};
__decorate([
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ChainController.prototype, "delete", null);
ChainController = __decorate([
    common_1.Controller('chain'),
