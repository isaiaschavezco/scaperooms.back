...
export declare class TargetService {
    ...
    constructor(targetRepository: Repository<Target>, cityRepository: Repository<City>, chainRepository: Repository<Chain>, clinicRepository: Repository<Clinic>, typeRepository: Repository<Type>, positionRepository: Repository<Position>, roleRepository: Repository<Role>, delegationRepository: Repository<Delegation>);
